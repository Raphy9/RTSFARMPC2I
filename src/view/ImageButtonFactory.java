...
public class ImageButtonFactory {
    ...
    public static JButton createImageButton(String idlePath, String hoverPath, String pressedPath) {
        ...
        // On crée un bouton personnalisé qui redéfinit son propre dessin
        JButton button = new JButton() {
            @Override
            protected void paintComponent(Graphics g) {
                Image imgToDraw = idleIcon.getImage();

                // On choisit l'image selon l'état de la souris
                ...
                // LE SECRET EST ICI : On dessine l'image en forçant la taille à getWidth() et getHeight()
                if (imgToDraw != null) {
        ...
        button.setFocusable(false); // Protège le focus de la caméra

        // Optionnel : Retire le texte par défaut si tu n'utilises que l'image
        button.setText("");
