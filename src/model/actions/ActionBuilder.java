...
public abstract class ActionBuilder {
    ...
    /**
     * Getter pour le jardinier qui effectue l'action, qui peut être utilisé par les sous-classes pour accéder au jardinier lors de la construction de l'action finale.
     * Ce jardinier est celui qui a initié la planification de l'action, et c'est à lui que l'action finale sera donnée pour exécution une fois construite.
     * @return
     */
    ...
    /** Getter pour les coordonnées x de la case cible de l'action, par exemple la case à planter ou la case de la grange pour récupérer une graine.
    ...
    /** Getter pour les coordonnées y de la case cible de l'action, par exemple la case à planter ou la case de la grange pour récupérer une graine.
     * Ces coordonnées seront utilisées pour planifier le déplacement du jardinier vers la case cible avant d'exécuter l'action.
    ...
    /** Setter pour les coordonnées de la case cible de l'action, par exemple la case à planter ou la case de la grange pour récupérer une graine.
     * Ces coordonnées seront utilisées pour planifier le déplacement du jardinier vers la case cible avant d'exécuter l'action.
    ...
    /** Getter pour la Display, qui peut être utilisée par les sous-classes pour demander des effets visuels lors de la planification des actions.
